...
Using our small and dense simulation described in table \ref{tab:sims}, after the CIC (in a 256x256x256 grid) and V-Web have been aplied, we can form the FA and visualize its histogram (Figure \ref{fg:hist_FA}) and a 2-D cut (Figure \ref{fg:cut_FA}).
%Histogram and cut
\begin{figure}[ht]
\centering
...
%General results of the simulation. Show the
% histogram for the FA and the Overdensity

%Show cuts of the FA and of the Overdensity
