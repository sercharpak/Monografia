...
%TODO Explain the Friedman Equation of the model 
\end{par}
...
\subsection{Simple implementation of the Region Growing Algorithm with the FA and $tr\left(\sum_{\alpha\beta}\right)$}

\subsubsection{Region Growing Algorithm with the FA and $tr \left(\sum_{\alpha\beta}\right)$} \label{sec:results_own_impl}
