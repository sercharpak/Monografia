...
#Prepares the output file
output_name = './group_valid_positions_FA_Trace_seeds_FA_'+str(seeds_thresh_FA)+'_Trace_'+str(seeds_thresh_Trace)+'_search_FA_'+str(search_thresh_FA)+'_Trace_'+str(search_thresh_Trace)+'.dat'
