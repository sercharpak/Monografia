...
ax.set_title('Regions obtained at scale with the simulation for parameters \n Seeds (FA:'+str(thresh_seeds_FA)+
' $\delta$:'+str(thresh_seeds_Trace)+') \n Search (FA:'+str(thresh_search_FA)+
' $\delta$:'+str(thresh_search_Trace)+')', size=35)
...
if(int(sys.argv[3]) == 1):
    ...
    for id_group in id_groups:
        ...
        fig = plt.figure(figsize=(25, 25))
        ax = fig.add_subplot(111, projection='3d')
        ax.scatter(x_particles,y_particles,z_particles,s=20)
        ...
        ax.set_ylabel('j', size=30)
        ax.set_zlabel('k', size=30)
        ax.set_title('Region '+str(id_group)+' for parameters \n Seeds (FA:'+str(thresh_seeds_FA)+
        ' $\delta$:'+str(thresh_seeds_Trace)+') \n Search (FA:'+str(thresh_search_FA)+
        ' $\delta$:'+str(thresh_search_Trace)+')', size=35)
        ax.tick_params(axis='both', which='major', labelsize=30)
        ...
        ax.set_ylabel('j', size=30)
        ax.set_zlabel('k', size=30)
        ax.set_title('Region '+str(id_group)+' at scale in the simulation for parameters \n Seeds (FA:'+str(thresh_seeds_FA)+
        ' $\delta$:'+str(thresh_seeds_Trace)+') \n Search (FA:'+str(thresh_search_FA)+
        ' $\delta$:'+str(thresh_search_Trace)+')', size=35)
        ax.tick_params(axis='both', which='major', labelsize=30)
