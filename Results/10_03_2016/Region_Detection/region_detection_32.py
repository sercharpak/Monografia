...
results_path = '/lustre/home/ciencias/fisica/pregrado/sd.hernandez204/Outputs/region_detect/10_03_2016/32_GB/'
...
ax.set_ylabel('Y kpc/h', size=30)
ax.set_zlabel('Z kpc/h', size=30)
ax.set_title('Regions obtained at scale, \n with the other points of the simulation', size=35)
ax.tick_params(axis='both', which='major', labelsize=30)
plt.savefig(results_path+"regions_all_small.png",format = 'png')
plt.close(fig)
...
ax.tick_params(axis='both', which='major', labelsize=30)
plt.savefig(results_path+"regions_all_big.png",format = 'png')
plt.close(fig)
