...
plt.xlabel("$\lambda_a$ - $\lambda_b$ / ($\lambda_a$ + $\lambda_b$ + $\lambda_c$)")
plt.ylabel("$\lambda_b$ - $\lambda_c$ / ($\lambda_a$ + $\lambda_b$ + $\lambda_c$)")
plt.grid()
plt.title("Inertia Tensor EigenValues diffrences for groups with "+str(n_groups) + " groups \n growth: FA: " + str(thresh_search_FA) + " Trace: " + str(thresh_search_Trace) +"\n seeds: FA: " + str(thresh_seeds_FA) + " Trace: " + str(thresh_seeds_Trace))
